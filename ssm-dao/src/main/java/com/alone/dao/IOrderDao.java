...
public interface IOrderDao {
    ...
    * */
    ...
    @Results({
            ...
            @Result(property = "orderDesc",column = "orderDesc"),
            @Result(property = "product",column = "productId",one = @One(select = "com.alone.dao.IProductDao.findById")),
            @Result(property = "travellers",column = "id",many = @Many(select = "com.alone.dao.ITravellerDao.findById")),
            @Result(property = "member",column = "memberId",one = @One(select = "com.alone.dao.IMemberDao.findById"))
    })
